...
const ProductAdmin = () => {
  ...
  useEffect(() => {
    fetchProductData();
  }, [page, search]); // Added search to this dependency list to re-fetch when search changes.
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(timeoutId); // Clear timeout when component unmounts or search changes.
  }, [search]); // Fetch data only when search changes.
